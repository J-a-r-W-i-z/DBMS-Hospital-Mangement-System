# Generated by Django 3.2.18 on 2023-03-06 14:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Patient',
            fields=[
                ('AadharId', models.CharField(max_length=15, primary_key=True, serialize=False)),
                ('Name', models.TextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'frontDeskOperator'), (2, 'dataOperator'), (3, 'doctor'), (4, 'admin')])),
        ...
        migrations.CreateModel(
            name='Administrator',
            fields=[
                ('EmployeeId', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='HM_System.user')),
                ('Name', models.TextField()),
                ('Address', models.TextField()),
                ('Phone', models.TextField()),
                ('Email', models.TextField()),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('Appointment', 'Treatment'), name='second_constraint'),
        ),
        migrations.AddConstraint(
